   ...
   private:
    ...
    debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
        ...
        if (pCallbackData == nullptr) {
            throw std::runtime_error("pCallbackData is a nullptr");
        }
    ...
    VkSampleCountFlagBits getMaxUsableSampleCount() {
        ...
        // TODO: Test what happens if I return counts
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilites) {
        if (capabilites.currentExtent.width !=
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
        ...
        if (vkCreateBuffer(device, &bufferInfo, nullptr, &buffer) !=
            VK_SUCCESS) {
            throw std::runtime_error("failed to create vertext buffer!");
        }
    ...
    void createDescriptorSetLayout() {
        ...
        if (vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr,
            ...
            throw std::runtime_error("failed to creaet desciptor set layout!");
        }
    }
